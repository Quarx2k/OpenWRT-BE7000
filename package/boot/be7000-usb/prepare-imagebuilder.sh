...
while read -r name separator version; do
    case "$name" in
        be7000-*|kmod-ath*|kmod-cfg80211|kmod-mac80211|kmod-qmi-helpers|kmod-qrtr-smd|kmod-qcom-wcss-sec-compat|kmod-qcom-ppe-offload|ath11k-firmware-ipq9574|ath12k-firmware-qcn9274)
