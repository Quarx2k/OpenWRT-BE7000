...
extern int kexec_secondary_park_prepare(void);
extern int kexec_secondary_park_cpus(unsigned long expected_online_mask,
				     unsigned long *parked_mask);
extern bool kexec_secondary_park_complete(void);
