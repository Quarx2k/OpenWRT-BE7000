...
The first update needs another 3 GiB on the USB drive: the new version is stored alongside the previous one. Older installations without a `slots` directory need a fresh install.
